...
Find the full documentation [here](https://diffice-jax.readthedocs.io/en/latest/). We provided the documentation for both the algorithms (e.g., cost functions and PDEs) and the mathematical formulation for the data assimilation of ice shelves.
