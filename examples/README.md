...
provided in the `colab` subfolder, which can also be opened by clicking
...
An companion Colab Notebook of this script is provided in the `colab` subfolder, which can also be opened by clicking
