...
Conventional method for solving inverse problems in glaciology includes control method, or called adjoint method [@MacAyeal1993; @vieli2003application; @morlighem2010spatial; @goldberg2011data; @morlighem2013inversion; @perego2014optimal; @furst2015assimilation; @barnes2021transferability], which is a PDE-constraint optimization method that requires deriving extra adjoint equations [@MacAyeal1993; @morlighem2013inversion]. In addition, data used in inverse problems also contains noise. Adjoint method often needs to work with additional regularization techniques to prevent error propagation. These challenges discourage broad communities from using adjoint method to solve inverse problems. In comparison, the newly-developed physics-informed neural networks (PINNs) provides a simpler approach. It has been demonstrated that PINNs can inherently de-noise the data while solving the inverse problem [@wang2022discovering; @riel2023variational; @iwasaki2023one] without the need of regularization terms in the cost function. Based on back-propagation and automatic differentiation, PINNs also do not require the derivation of ajoint equations, which is convenient for solving complex problems that involves multiple coupled PDEs. 
