...
have provided a Jupyter notebook (.ipynb) file that allows users to run the code online in Google Colab.
...
<p align="center">
    <img src="figures/syndata_cond.png" alt="boundary conditions" width="100%">
</p>
